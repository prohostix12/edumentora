    ...
    <section className="py-24 lg:py-32 bg-bg-section">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          >
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                className="group relative flex items-start gap-4 rounded-[1.5rem] bg-gradient-to-b from-white to-bg-section/50 p-6 border border-border/70 shadow-soft hover:shadow-card hover:-translate-y-1 hover:border-primary/20 transition-all duration-500 overflow-hidden"
              >
                ...
                <div className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary/10 to-secondary/10 ring-1 ring-border/60 group-hover:bg-gradient-to-br group-hover:from-primary group-hover:to-primary-dark group-hover:ring-primary/30 transition-all duration-500">
                ...
                <div>
                  ...
                  {info.details.map((detail, i) => (
                    <p key={i} className="text-sm text-paragraph">
                      {detail}
                    </p>
                  ))}
                </div>
          ...
          >
            <div className="relative rounded-[2rem] bg-gradient-to-b from-white to-bg-section/40 p-8 lg:p-10 border border-border/70 shadow-card overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-border bg-bg-section px-4 py-3 text-sm text-heading placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium"
                      required
                    />
                  </div>
                  <div>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full rounded-xl border border-border bg-bg-section px-4 py-3 text-sm text-heading focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-border bg-bg-section px-4 py-3 text-sm text-heading placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all resize-none font-medium"
                    required
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-primary to-primary-dark px-8 py-4 text-base font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 disabled:opacity-60 cursor-pointer"
                >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7 }}
          className="mt-16 rounded-3xl overflow-hidden border border-border shadow-card"
        >
          <iframe
