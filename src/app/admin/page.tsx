...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex text-gray-800">
      {/* 1. Sidebar - Desktop */}
      <aside className="hidden lg:flex flex-col justify-between w-64 bg-slate-900 text-white shrink-0 border-r border-slate-800">
        <div>
          {/* Logo / Header */}
          <div className="flex items-center gap-3 p-6 border-b border-slate-800">
            ...
            <div>
              <h1 className="font-extrabold text-sm tracking-wide uppercase text-white">Edumentora</h1>
              <span className="text-[10px] font-bold text-gray-400">ADMIN PORTAL</span>
            </div>
          </div>
            ...
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 text-left ${
                    isActive
        ...
        <div className="p-4 border-t border-slate-800">
          <button
            onClick={() => router.push('/')}
            className="flex w-full items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold text-gray-400 hover:text-white hover:bg-slate-800/50 transition-all text-left"
          >
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex lg:hidden animate-fadeIn">
          ...
          <aside className="relative flex flex-col justify-between w-64 bg-slate-900 text-white h-full animate-slideRight">
            <div>
              <div className="flex items-center justify-between p-6 border-b border-slate-800">
                <div className="flex items-center gap-2">
                  ...
                  <h1 className="font-extrabold text-sm tracking-wide text-white">Edumentora</h1>
                </div>
                ...
                {menuItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex w-full items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all text-left ${
                        isActive
        ...
        <header className="h-16 bg-white border-b border-gray-100 px-6 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
            <button
              ...
              className="lg:hidden p-1.5 text-gray-500 hover:bg-gray-50 rounded-lg border border-gray-100"
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex flex-col text-right">
              <span className="text-xs font-bold text-gray-900">admin@edumentora.com</span>
              <span className="text-[10px] font-bold text-gray-400">Administrator</span>
            </div>

            {/* Avatar Badge */}
            <div className="h-9 w-9 rounded-full bg-blue-100 border border-blue-200 text-blue-600 font-extrabold text-sm flex items-center justify-center shadow-inner">
              A
            </div>
            ...
            <button
              ...
              className="p-2 text-red-500 hover:bg-red-50 hover:text-red-600 border border-transparent hover:border-red-100 rounded-xl transition-all"
              title="Sign Out"
            >
          ...
          {activeTab === 'dashboard' && (
            countsLoading ? (
              <div className="flex flex-col items-center justify-center p-24">
                ...
                <p className="text-gray-500">Retrieving stats...</p>
              </div>
            ) : (
